    ...
    },
    {
      ...
      value: function getResourceBundle(lng, ns) {
        ...
        if (this.options.compatibilityAPI === 'v1')
          return _objectSpread2(_objectSpread2({}, {}), this.getResource(lng, ns));
        ...
        value: function translate(keys, options, lastKey) {
          ...
          if (
            ...
            var defaultValueSuffix = needsPluralHandling
              ...
              : '';
            var defaultValue =
              options['defaultValue'.concat(defaultValueSuffix)] || options.defaultValue;
        ...
        value: function extendTranslation(res, key, options, resolved, lastKey) {
          ...
          if (this.i18nFormat && this.i18nFormat.parse) {
            res = this.i18nFormat.parse(
              res,
              _objectSpread2(
                _objectSpread2({}, this.options.interpolation.defaultVariables),
              ...
              this.interpolator.init(
                _objectSpread2(_objectSpread2({}, options), {
                  interpolation: _objectSpread2(
                    _objectSpread2({}, this.options.interpolation),
          ...
          if (key.indexOf(_this.formatSeparator) < 0) {
            ...
            return _this.alwaysFormat
              ? _this.format(
                  ...
                  lng,
                  _objectSpread2(
                    _objectSpread2(_objectSpread2({}, options), data),
                    {},
                    {
      ...
      value: function nest(str, fc) {
        ...
        function handleHasOptions(key, inheritedOptions) {
          ...
          try {
            ...
            if (inheritedOptions)
              clonedOptions = _objectSpread2(_objectSpread2({}, inheritedOptions), clonedOptions);
          } catch (e) {
          ...
          if (_this.formats[formatName]) {
            ...
            try {
              ...
              formatted = _this.formats[formatName](
                ...
                l,
                _objectSpread2(
                  _objectSpread2(_objectSpread2({}, formatOptions), options),
                  valOptions,
                ),
              );
            } catch (error) {
  ...
  _createClass(Connector, [
    ...
    },
    {
      ...
      value: function saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
        ...
        var clb =
          arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : function () {};
        if (
          this.services.utils &&
  ...
  _createClass(I18n, [
    {
      ...
      value: function init() {
        ...
        this.options = _objectSpread2(
          _objectSpread2(_objectSpread2({}, defOpts), this.options),
          transformOptions(options),
        );
        if (this.options.compatibilityAPI !== 'v1') {
          this.options.interpolation = _objectSpread2(
            _objectSpread2({}, defOpts.interpolation),
            this.options.interpolation,
          );
        }
    ...
    },
    {
      ...
      value: function cloneInstance() {
        ...
        var mergedOptions = _objectSpread2(
          _objectSpread2(_objectSpread2({}, this.options), options),
          {
            isClone: true,
          },
        );
